...
// From: https://discussions.unity.com/t/lwrp-using-2d-lights-in-a-particle-system-emitter/752498/13
...
public class AttachGameObjectsToParticles : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        while (m_Instances.Count < count)
            m_Instances.Add(Instantiate(m_Prefab, m_ParticleSystem.transform, true));
